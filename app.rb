...
get '/' do
  ...
  months = [
    ...
    { id: 8, month_id: '8月/08 AUG', month: 'Aug',title:'臺南菁寮天主堂', title_en:'Tainan Jingliao Saint Cross Catholic Church', img: 'https://meee.com.tw/WbBfbG7.jpg', copywriting: '在臺南後壁菁寮社區稻田間矗立著4座聖十字架天主堂，1957年為傳教開始興建，由德國建築師哥特佛萊德．波姆設計，其設計靈感來自稻米收成後的稻草堆。悠揚的鐘聲早已成為附近居民的生活點綴。', copyen: "In the Jingliao neighborhood of Tainan, amidst the rice paddies, stand the four towers of the Saint Cross Catholic Church. Construction began in 1957 to facilitate missionary work. The church was designed by German architect Gottfried Böhm and was inspired by stacks of rice straw after the harvest. The melodious ringing of the bells has long become a cherished part of the local residents' daily life."},
    { id: 9, month_id: '9月/09 SEP', month: 'Sep',title:'基隆中元祭放水燈', title_en:'Releasing Water Lanterns at Keelung Ghost Festival  ', img: 'https://meee.com.tw/hpqdTzM.jpg', copywriting: '為期一個月臺灣規模最大且歷史最久的基隆中元祭，每年都會在農曆7月14日午夜進行放水燈儀式，水燈替無後人奉祀的亡魂引路，引領祂們到陽間接受民眾的普渡供品。', copyen: 'The Keelung Ghost Festival, the largest and longest-running festival of its kind in Taiwan, spans a month. Every year, on the 14th day of the seventh lunar month at midnight, a water lantern ceremony is conducted. These lanterns guide the souls who have no descendants to honor them, leading them to the world of the living to receive offerings from the public.'},
