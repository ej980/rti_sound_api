...
get '/' do
  ...
  months = [
    { id: 1, month_id: '1月 January', month: 'JAN', title: '臺灣藍鵲', mobile: 'https://meee.com.tw/xff0153', pc: 'https://meee.com.tw/p4h6BND', title_en: 'Taiwan Blue Magpie', img: 'https://meee.com.tw/HlI4HUH.jpg', copywriting: '位於圓山風景區的央廣圓山微波站是節目傳輸的起點，Rti的節目訊號由此傳送至各地分臺再向全球播送。漫步其中，常可見到臺灣特有鳥種臺灣藍鵲成群的身影，並聞其鳴叫聲。' , copyen: 'Located in the Yuanshan scenic area, Rti’s Yuanshan microwave transmission station is the starting point for transmitting programs. From here, Rti’s signal is sent to various substations and broadcast globally. As you walk around the area, you can often see flocks of Taiwan’s endemic bird, the Taiwan blue magpie, and hear their calls.' },
